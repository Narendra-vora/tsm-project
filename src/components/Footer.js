...
//                     {/* Col 2 — Products */}
//                     <div>
//                         <h3 className="text-3xl  text-[#E05A36] mb-4 tracking-wide ">Products</h3>
//                         <div className="w-64 h-[2px] bg-white/15 mb-6 rounded-full" />
...
//                                     <Link
//                                         href="/products"
//                                         className="text-md text-blue-200 hover:text-white transition-colors leading-snug"
...
//                     <div>
//                         <h3 className="text-2xl  text-[#E05A36] mb-2 tracking-wide ">Also in Our Portfolio</h3>
...
//                     <div>
//                         <h3 className="text-2xl  text-[#E05A36] mb-2 tracking-wide ">Contact & Location</h3>
//                         <div className="w-64 h-[2px] bg-white/15 mb-3 rounded-full" />
//                         <ul className="space-y-1.5">
//                             <li className="flex items-start gap-2">
//                                 <span className="text-blue-300 mt-0.5 text-md">📍</span>
//                                 <span className="text-md text-blue-200 leading-snug">Ahmedabad, Gujarat, India</span>
//                             </li>
//                             <li className="flex items-start gap-2">
//                                 <span className="text-blue-300 mt-0.5 text-md">✉️</span>
//                                 <a
//                                     href="mailto:sales@ts11.in"
//                                     className="text-md text-blue-200 hover:text-white transition-colors"
//                                     style={{ textDecoration: "none" }}
//                                 >
//                                     sales@ts11.in
//                                 </a>
...
//                                     label: "Facebook",
//                                     svg: (
//                                         <svg viewBox="0 0 320 512" width="22" height="22" fill="white">
...
//                                     aria-label={s.label}
//                                     className="w-7 h-7 rounded-full border border-blue-400/40 bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors"
//                                     style={{ textDecoration: "none" }}
//                                 >
//                                     {s.svg}
//                                 </a>
...
//                 {/* Divider */}
//                 <div className="border-t border-white/15 mt-9 pt-4 flex items-center justify-between">
//                     <div className="flex gap-5">
//                         <Link
//                             href="/privacy-policy"
//                             className="text-md text-blue-300 hover:text-white transition-colors"
//                             style={{ textDecoration: "none" }}
//                         >
//                             Privacy Policy
//                         </Link>
            ...
            <div className="w-full mx-auto px-6 py-8">
                ...
                <div className="grid grid-cols-4 gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p className="text-lg text-blue-200 leading-relaxed max-w-[350px]">
                    ...
                    {/* Col 2 — Products */}
                    <div>
                        <h3 className="text-2xl  text-[#E05A36] mb-3 tracking-wide ">Products</h3>
                        <div className="w-32 h-[2px] bg-white/15 mb-2 rounded-full" />
                        <ul className="space-y-1.5">
                            {[
                                "Integrex Medical Air Compressor",
                                "Medical Vacuum Pump System – Rotary Vane",
                    ...
                    {/* Col 3 — Also in Our Portfolio */}
                    <div>
                        <h3 className="text-2xl  text-[#E05A36] mb-3 tracking-wide ">Also in Our Portfolio</h3>
                        <div className="w-32 h-[2px] bg-white/15 mb-2 rounded-full" />
                        <ul className="space-y-1.5">
                            {[
                                "Medical Vacuum Pump System – Reciprocating",
                    ...
                    {/* Col 4 — Contact & Location */}
                    <div>
                        <h3 className="text-2xl  text-[#E05A36] mb-3 tracking-wide ">Contact & Location</h3>
                        <div className="w-32 h-[2px] bg-white/15 mb-2 rounded-full" />
                        <ul className="space-y-1.5">
                            <li className="flex items-start gap-2">
                                <span className="text-blue-300 mt-0.5 text-lg">📍</span>
                                <span className="text-lg text-blue-200 leading-snug">Ahmedabad, Gujarat, India</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-blue-300 mt-0.5 text-lg">✉️</span>
                                <a
                                    href="mailto:sales@ts11.in"
                            ...
                            {[
                                {
                                    ...
                                    label: "WhatsApp",
                                    svg: (
                                        <svg viewBox="0 0 34 34" width="18" height="18" fill="#0b477b">
                                            <path d="M16.001 3C9.373 3 4 8.373 4 15c0 2.354.687 4.548 1.872 6.396L4 29l7.789-1.83A11.94 11.94 0 0 0 16.001 27C22.628 27 28 21.627 28 15S22.628 3 16.001 3zm0 21.818a9.78 9.78 0 0 1-4.994-1.367l-.358-.213-4.622 1.087 1.234-4.5-.233-.37A9.77 9.77 0 0 1 6.182 15c0-5.42 4.4-9.818 9.819-9.818S25.818 9.58 25.818 15 21.42 24.818 16.001 24.818zm5.377-7.34c-.294-.147-1.741-.859-2.011-.957-.27-.098-.467-.147-.663.147-.196.294-.76.957-.932 1.153-.171.196-.343.221-.637.074-.294-.147-1.242-.457-2.366-1.457-.874-.78-1.464-1.743-1.636-2.037-.171-.294-.018-.453.129-.6.132-.132.294-.343.441-.514.147-.171.196-.294.294-.49.098-.196.049-.368-.025-.514-.074-.147-.663-1.598-.909-2.189-.24-.575-.484-.497-.663-.507l-.564-.01c-.196 0-.514.074-.784.368-.27.294-1.03 1.006-1.03 2.454 0 1.447 1.055 2.846 1.202 3.042.147.196 2.077 3.17 5.033 4.444.703.303 1.252.484 1.68.62.706.225 1.348.193 1.856.117.566-.085 1.741-.712 1.986-1.4.245-.688.245-1.277.171-1.4-.074-.123-.27-.196-.564-.343z" />
                                        </svg>
                                    ),
                                },
                                {
                                    ...
                                    label: "Facebook",
                                    svg: (
                                        <svg viewBox="0 0 320 512" width="18" height="18" fill="#0b477b">
                                            <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" />
                                        </svg>
                                    ),
                                },
                                {
                                    ...
                                    label: "LinkedIn",
                                    svg: (
                                        <svg viewBox="0 0 448 512" width="18" height="18" fill="#0b477b">
                                            <path d="M100.28 448H7.4V148.9h92.88zm-46.44-341C24.09 107 0 82.9 0 53.19a53.19 53.19 0 0 1 106.38 0c0 29.71-24.1 53.81-53.9 53.81zM447.9 448h-92.68V302.4c0-34.7-.7-79.34-48.34-79.34-48.35 0-55.75 37.75-55.75 76.78V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.7-48.3 87.9-48.3 94 0 111.3 61.9 111.3 142.3V448z" />
                                        </svg>
                                    ),
                                },
