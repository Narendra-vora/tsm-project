...
// ─── Hover Zoom Card wrapper ─────────────────────────────────
function HoverCard({ children, style = {}, scale = 1.045 }) {
        ...
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 28 }}>
            {[
              ...
              <FadeUp key={p.name} delay={pi * 120} style={{ height: "100%" }}>
        ...
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 26 }}>
            {[
              ...
              <FadeUp key={f.title} delay={fi * 100}>
                <HoverCard style={{ borderRadius: 10 }}>
                  <div style={{
                    background: "#0b477b",
                    borderRadius: 10,
                    padding: "24px 20px",
        ...
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32 }}>
            {[
              ...
              <FadeUp key={w.title} delay={wi * 100}>
                <HoverCard style={{ borderRadius: 14, padding: "16px", background: "#f9fbff" }}>
                  <div>
